  ...
  $(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
      ...
      defaultDate: '2015-05-12',// this allows things to be dropped onto the calendar
      dayClick: function(start, end, allDay) {
    var title = prompt('Select time(in given 24h-format):', 'hh:mm');
    var tok = title.split(":");
    ...
    calendar.fullCalendar('unselect');
      ...
      //   {
      //     id: 999,
      //     title: 'Repeating Event - Computer Sciences',
