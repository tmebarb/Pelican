        ...
        <div class="navbar-fixed">
            <nav class="cyan">
                <div class="nav-wrapper">
                    <h1 class="logo-wrapper"><a href="<?php echo base_url() ?>" class="brand-logo darken-1"><img src="<?php echo base_url() ?>asserts/images/Pelican logo.png" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1>
