          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Delete Advisee</h5>
                <ol class="breadcrumb">
                  <li><a href="dashboard">Dashboard</a>
                  </li>
                  <li><a href="?php echo base_url() ?>staff_member/ListAdvisees">Advisee</a>
                  </li>
                  ...
                  <div class="col s12 m8 l9">
                    <div class="card  light-blue">
                      <div class="card-content white-text">
                        ...
                        <p> Success! <?php echo $advisee_name;?> has been deleted!</p>
                      </div>
                      <div class="card-action">
                        <a href="<?php echo base_url() ?>Staff_member/deleteAdvisee" class="lime-text text-accent-1">Delete Another Advisee</a>
