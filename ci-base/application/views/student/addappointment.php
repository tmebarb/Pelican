        ...
        $(function () {
            ...
            $("#date").change(function() {
                ...
                if(day == 1)
                    ...
                    dayName = "friday";
                $.ajax({
                    url: "<?php echo base_url(); ?>/student/getAdvisorSlotsByDayNDate/" + $("#date").val() + "/" + dayName + "/<?php echo $advisor->advisor_id ?>",
        ...
        <div id="basic-form" class="section">
            <form action="">
                <div class="card-panel">
                    <img src="<?php echo base_url() ?>asserts/images/hex-loader2.gif" alt="" id="loadingDiv" style="margin: auto 0px; text-align: center; padding-left: 31%;">
                    <div class="right">Your Advisor: <strong><?php
                    ...
                    <div class="row">
                        ...
                        <div class="col s6">
                            <p>Note: Your advisor is only available from '<span style="color: #78cf54"><?php echo $sessionDetails->startDate ?></span>' to '<span style="color: #78cf54"><?php echo $sessionDetails->endDate ?></span>'</p>
                        </div>
                    </div>
                    <div class="row">
