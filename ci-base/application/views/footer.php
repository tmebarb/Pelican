    ...
    <footer class="page-footer" style="position: fixed; z-index: 999">
        ...
        <div class="footer-copyright">
            <div class="container">
                Copyright © 2016 <a class="grey-text text-lighten-4" target="_blank">Pelican</a> All rights reserved.
                <span class="right"> Design and Developed by <a class="grey-text text-lighten-4">VSWKT</a></span>
            </div>
        </div>
    </footer>
    <!-- END FOOTER -->
